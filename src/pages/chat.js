...
import ClickIcon from "../assets/icons/double-click.svg";
...
function Chat() {
    ...
    return (
        <div className="relative w-full sm:px-10 px-2">
            ...
            <div className="mt-8" >
                ...
                <div className="chat-box h-96 overflow-y-auto flex flex-col py-4">
            ...
            <div className="sm:px-10 px-4 fixed inset-x-0 bottom-0 flex justify-between pb-2 w-full">
                <div className="flex items-center justify-between gap-4 w-full">
                    ...
                    <div className="h-[56px] bg-[#F9FAFB] flex justify-between w-full gap-2">
                        <input type="text" value={inputText} className="w-full outline-none text-[14px] text-black/40 font-bold" placeholder="Food Runs typing....." onChange={(e) => setInputText(e.target.value)}></input>

                        <button onClick={handleSend}>
                            <img src={ClickIcon} alt="double click icon" />
                        </button>
                    </div>
                </div>
            </div>
